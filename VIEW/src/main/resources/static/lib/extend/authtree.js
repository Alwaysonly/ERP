...
layui.define(['jquery', 'form'], function (exports) {
    ...
    obj = {
        ...
        render: function (dst, trees, opt) {
            ...
            var datacolumn = opt.datacolumn ? opt.datacolumn : {title: 'title', value: 'value'};
        ...
        renderAuth: function (tree, dept, opt) {
            ...
            layui.each(tree, function (index, item) {
                ...
                str += '<div><div class="auth-status"> ' +
                    ...
                    (dept > 0 ? '<span>├─ </span>' : '') +
                    '<input type="checkbox" name="' + inputname + '" title="' + item[datacolumn.title] + '" value="' + item[datacolumn.value] + '" lay-skin="primary" lay-filter="' + layfilter + '" ' +
